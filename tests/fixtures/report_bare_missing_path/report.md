# Verification Report: Bare Missing Path Fixture

## task_id

`WP-TEST-bare-missing-path`
...
This fixture references a missing repo path without backticks.

## files_read

- tests/fixtures/report_bare_missing_path/does-not-exist.md - intentionally missing bare path.
...
- files_inspected: tests/fixtures/report_bare_missing_path/does-not-exist.md
...
Reject this report because its bare repo path is not replayable.
